...
CREATE TABLE BAIRRO(
    ...
    CONSTRAINT FK_BAIRRO_ESTADO FOREIGN KEY (id_estado) REFERENCES CIDADE(id_estado)
);
...
CREATE TABLE ENDERECO(
    ...
    CONSTRAINT FK_ENDERECO_CIDADE FOREIGN KEY (id_cidade) REFERENCES BAIRRO(id_cidade)
);
